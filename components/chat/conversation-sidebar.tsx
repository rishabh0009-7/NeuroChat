                ...
                <div className="flex items-start justify-between">
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center space-x-2 mb-1">
                      {conversation.isPinned && (
                        <Pin className="h-3 w-3 text-yellow-500 flex-shrink-0 fill-current" />
                      )}
                  ...
                  <div className="opacity-0 group-hover:opacity-100 transition-opacity flex items-center space-x-1">
                    <Button
                      variant="ghost"
                      size="sm"
                      onClick={(e) => handleConversationAction(e, "pin", conversation.id)}
                    ...
                    <Button
                      variant="ghost"
                      size="sm"
                      onClick={(e) => handleConversationAction(e, "archive", conversation.id)}
                    ...
                    <Button
                      variant="ghost"
                      size="sm"
                      onClick={(e) => handleConversationAction(e, "delete", conversation.id)}
